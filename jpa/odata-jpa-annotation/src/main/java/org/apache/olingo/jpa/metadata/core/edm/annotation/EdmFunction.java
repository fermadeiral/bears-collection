...
public @interface EdmFunction {
	...
	/**
	 * @return the name of the function in the service document
	 */
	String name();
	...
	/**
	 * @return the name of a Stored Procedure respectively User Defined Function on
	 *         the database
	 */
	...
	boolean isBound() default true;
  	...
  	/**
	 * Indicates that a Function Import shall be generated into the Container. For
	 * details see: <a href =
	 ...
	 * > edm:FunctionImport</a>
	 * <p>
	 * hasFunctionImport is handled as follows:
	 * <p>
	 * <ol>
	 * <li>For <b>bound</b> functions hasFunctionImport is always treated as
	 * <b>false</b></li>
	 * <li>For <b>unbound</b> functions in case hasFunctionImport is <b>true</b> a
	 * function import is generated, which allows to be call a function from the
	 * container</li>
	 * </ol>
	 */
