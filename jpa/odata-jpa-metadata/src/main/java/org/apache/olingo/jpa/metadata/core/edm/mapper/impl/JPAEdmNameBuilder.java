...
public final class JPAEdmNameBuilder {
	...
	public String buildEnumTypeName(final Class<? extends Enum<?>> enumType) {
	...
	final public String buildNaviPropertyBindingName(final JPAAssociationPath associationPath,
		...
		for (final JPAElement pathElement : associationPath.getPathElements()) {
			name.append(JPASelector.PATH_SEPERATOR);
